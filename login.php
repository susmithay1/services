...
<head>
    ...
    <title>FEED | General Login</title>
    ...
    <div class="container-fluid">
        ...
        <div class="row content-row">
            <div class="col-lg-8 m-auto" style="padding:30px!important;">
                <h2><img src="./images/login.svg" alt="about" class="content-header-img"/>&nbsp;General Login</h2>
                <hr/>
                    ...
                    <div class="form p-3">
                        <form method="POST" id="login">
                            <div class="form-group mb-3">
                                <input type="text" name="gid" placeholder="Your ID" class="form-control" id="email">
                            </div>
                            <div class="form-group mb-3">
                                <input type="password" name="password" placeholder="Password" class="form-control" id="password">
                            </div>
                            <div class="form-group mb-3 text-center sendbtn">
                                <button type="submit"><span class="text">Login</span></button>
                            </div>
                            <div class="form-group text-center">
                                <p>Don't have an account?<a href="register.php" style="color:blue;text-decoration:underline!important;">Register Here</a></p>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function(){
            $("#login").submit(function(e){
                e.preventDefault();
                $.ajax({
                    url:`http://${window.location.hostname}/feedweb/api/auth.php?login=true`,
                    type:'POST',
                    context:this,
                    data:$(this).serialize(),
                    beforeSend:function(){
                        $(this).find(".text").text("Logging In...");
                    },
                    success:function(result,status,xhr){
                        ...
                        if(result.status == 1)
                        {
                            ...
                            window.location.href=`http://${window.location.hostname}/feedweb/modules.php`;
                        }
