...
<head>
    ...
    <!--Custom Styles-->
    <link rel="stylesheet" href="./css/workflow.css?<?php echo time();?>">
    <style>
        #logout
        {
            border:none;
    ...
    <div class="container-fluid">
        ...
        <div class="row content-row">
            <div class="col-lg-12" style="padding:30px!important;">
                <h2><img src="./images/workflow-icon.svg" alt="aworkflow" class="content-header-img"/>&nbsp;Feed Workflow</h2>
                <hr/>
                <img src="https://ik.imagekit.io/o0om8c0nr9/workflow-img_Dgfem2Egc.jpg" alt="workflow" class="wf-img">
            </div>
        </div>
